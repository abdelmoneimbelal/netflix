            ...
            <div class="row">
                ...
                <div class="col-10 mx-auto col-md-6 bg-white mx-auto p-3">
                    ...
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <hr>
                        <a href="/login/facebook" class="btn btn-block btn-primary fab fa-facebook-f"
                           style="background:#3b5998;"> Login by
                            Facebook</a>
                        <a href="/login/google" class="btn btn-block btn-primary fab fa-google"
                           style="background:#ea4335;"> Login by
                            Gmail</a>
