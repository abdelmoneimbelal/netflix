            ...
            <div class="tile mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="search" autofocus class="form-control"
                                               placeholder="search ny name, description, rating, year"
                ...
                <div class="row">
                    <div class="col-md-12">
                                ...
                                @foreach ($movies as $index=>$movie)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="#" disabled class="btn btn-danger btn-sm"><i
                        ...
                        @else
                            <h3 class="alert alert-danger" style="font-weight: 400;">Sorry no records found</h3>
                        @endif
                    </div>
                </div>
            </div><!-- end of tile -->
