        ...
        <div class="col-md-12">
            <div class="tile mb-4">
                ...
                <input type="file" name=""
                       data-movie-id="{{ $movie->id }}" id="movie__file-input"
                ...
                <form id="movie__properties"
                    ...
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" value="{{ old('name', $movie->name) }}" id="movie__name" value=""
                               class="form-control">
                    </div>
                    ...
                    <select name="categories[]" class="form-control select2" multiple>
                        ...
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}"
                                ...
                                $movie->categories->pluck('id')->toArray()) ? 'selected' : ''}}>
                    ...
                    <div class="form-group">
                        <label>Rating</label>
                        <input type="number" min="1" name="rating" value="{{ old('rating', $movie->rating) }}"
                               class="form-control">
                    </div>

                    <div class="form-group">
                        <button type="submit" id="movie__submit-btn"
                                style="display: {{ $errors->any() ? 'block' : 'none' }};" class="btn btn-primary"><i
                                class="fa fa-plus"></i>
                            Publish
                        </button>
                    </div>
